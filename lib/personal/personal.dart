...
import 'package:flutterbuild/common/touch_callback.dart';
import 'package:flutterbuild/common/im_item.dart';
          ...
          Container(
            ...
            child: Column(
              children: <Widget>[
                ...
                ImItem(imagePath: 'images/icon_me_photo.png',
                  title: '我的相册',
                ),
                Padding(padding: const EdgeInsets.only(left: 15.0, right: 15.0),
                  child: Divider(
                ...
                ImItem(imagePath: 'images/icon_me_file.png',
                  title: '我的文件',),
                Padding(padding: const EdgeInsets.only(left: 15.0, right: 15.0),
                  child: Divider(
                    height: 0.5,
                ...
                ImItem(imagePath: 'images/icon_me_service.png',
                  title: '联系客服',),
              ],
            ),
          ),
